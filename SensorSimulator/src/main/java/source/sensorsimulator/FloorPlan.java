...
public class FloorPlan {
   ...
   private void getFloorPlanGetFloor(String line, CellDescription cellDescription) {
      ...
      switch (line.substring(startIndex, endIndex)) {
         case "4":
            cellDescription.sI.floor = floorType.HIGH_PILE_CARPET;
            break;
         case "2":
            cellDescription.sI.floor = floorType.LOW_PILE_CARPET;
            break;
         default:
            cellDescription.sI.floor = floorType.BARE_FLOOR;
            break;
      }
   }
