   ...
   private class FloorJPanel extends JPanel
   {
      ...
      public void paintComponent(Graphics g)
      {
         ...
         for (int a = 0; a < Floor.size(); a++)
         {
            ...
            if (Floor.get(a).sI.west == SensorInterface.feature.OBSTICLE)
            {
            ...
            if (Floor.get(a).sI.east == SensorInterface.feature.OBSTICLE)
            {
            ...
            if (Floor.get(a).sI.south == SensorInterface.feature.OBSTICLE)
            {
            ...
            if (Floor.get(a).sI.north == SensorInterface.feature.OBSTICLE)
            {
