...
public class VirtualHouseTest {
   ...
   public void testSensorInformation() {
      ...
      assertEquals(tempSI.dirtPresent, true);
      assertEquals(tempSI.floor, SensorInterface.floorType.BareFloor);
      assertEquals(tempSI.north, SensorInterface.feature.OPEN);
      assertEquals(tempSI.east, SensorInterface.feature.OPEN);
      assertEquals(tempSI.south, SensorInterface.feature.STAIRS);
      assertEquals(tempSI.west, SensorInterface.feature.OBSTICLE);
      ...
      assertEquals(tempSI.dirtPresent, true);
      assertEquals(tempSI.floor, SensorInterface.floorType.BareFloor);
      assertEquals(tempSI.north, SensorInterface.feature.OBSTICLE);
      assertEquals(tempSI.east, SensorInterface.feature.OPEN);
      assertEquals(tempSI.south, SensorInterface.feature.OPEN);
      assertEquals(tempSI.west, SensorInterface.feature.OBSTICLE);
      ...
      instance.SensorInformation(tempSI);
       assertEquals(tempSI.atChargingStation, false);
      assertEquals(tempSI.dirtPresent, false);
      assertEquals(tempSI.floor, SensorInterface.floorType.HighPileCarpet);
      assertEquals(tempSI.north, SensorInterface.feature.OBSTICLE);
      assertEquals(tempSI.east, SensorInterface.feature.OBSTICLE);
      assertEquals(tempSI.south, SensorInterface.feature.OPEN);
      assertEquals(tempSI.west, SensorInterface.feature.OPEN);
      System.out.println("--Test starting cell of 1,0");
      instance.Move(1, 0);
      instance.SensorInformation(tempSI);
       assertEquals(tempSI.atChargingStation, false);
      assertEquals(tempSI.dirtPresent, true);
      assertEquals(tempSI.floor, SensorInterface.floorType.LowPileCarpet);
      assertEquals(tempSI.north, SensorInterface.feature.OPEN);
      assertEquals(tempSI.east, SensorInterface.feature.OBSTICLE);
      assertEquals(tempSI.south, SensorInterface.feature.OBSTICLE);
      assertEquals(tempSI.west, SensorInterface.feature.OPEN);
   }
}
